...
<head>
    ...
    <style>
        ...
        #aviso .container{max-width:1200px;min-height:65px;margin:0 auto;padding:0 10px;display:flex;align-items:center;justify-content:center;}
        #aviso span{color:#fff;font-size:14px;font-family:Arial;}
        #aviso span a{color:#fff;}
